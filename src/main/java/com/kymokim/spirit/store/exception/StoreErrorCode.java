...
public enum StoreErrorCode implements ErrorCode {
    ...
    STORE_CREATOR_ID_EMPTY(HttpStatus.BAD_REQUEST, 22007, "STORE_CREATOR_ID_EMPTY"),
    ...
    STORE_ORIGIN_IMG_URL_EMPTY(HttpStatus.BAD_REQUEST, 22012, "STORE_ORIGIN_IMG_URL_EMPTY");
