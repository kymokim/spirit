package com.kymokim.spirit.auth.log.service;
...
import com.kymokim.spirit.auth.log.exception.LogErrorCode;
import com.kymokim.spirit.auth.log.repository.StoreViewLogRepository;
